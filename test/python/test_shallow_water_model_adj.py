...
def test_shallow_water_model_adv_nsteps():
    ...
    xu = (state.u[xps-xms:xpe-xms+1, yps-yms:ype-yms+1] - u)
    xv = (state.v[xps-xms:xpe-xms+1, yps-yms:ype-yms+1] - v)
    xh = (state.h[xps-xms:xpe-xms+1, yps-yms:ype-yms+1] - h)
    xu = xu * 1000.0
    xv = xv * 1000.0
    xh = xh * 1000.0
    ...
    shallow_water.adv_nsteps(state, 100)
    yu = (state.u[xps-xms:xpe-xms+1, yps-yms:ype-yms+1] - u)
    yv = (state.v[xps-xms:xpe-xms+1, yps-yms:ype-yms+1] - v)
    yh = (state.h[xps-xms:xpe-xms+1, yps-yms:ype-yms+1] - h)
    yu = yu * 1000.0
    yv = yv * 1000.0
    yh = yh * 1000.0
